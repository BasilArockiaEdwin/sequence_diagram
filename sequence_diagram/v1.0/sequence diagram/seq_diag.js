...
! function() {
    ...
    var DIAGRAM_MARGIN = 10,
        ...
        LINE = {
            ...
            "stroke-width": 5  //TODO LINE_WIDTH
        },
        RECT = {
            fill: "#fff"
        };
...
img.attr({ "clip-rect": "20,20,30,30" });	
	   ...
	   /* c2.node.onclick = function (e) 
		{ /*alert('OnClick'); alert(e);  c2.attr("fill", "white"); c2.attr("stroke", "red");}; */
...
(function (c2) {
  ...
  function(){
    c2.attr({"stroke": "#000"});
	    ...
	    c2.hover(function (e) {
                /*alert(c2.node.id);*/ c2.attr("fill", "#303030");
            })
            return c2;
        },
...
$("#deq_1234_"+customTxt.split(',')[3]).hide();
	    ...
	    c1.node.onclick = function () { /*alert('Rect OnClick');*/ c1.attr("fill", "white");}; 
	    c1.attr("title",'Dakota Sequence Diagram \n Session Diagram');
	    c1.attr("fill", "white");
    ...
    var myWindow = window.open("www.w3schools.com", "", "width=400,height=400");
	 ...
	 /*Ends Here*/
	    ...
	    c1.hover(function (e) {
		//draw_tooltip(this, 1, display_text, 60, 60);
...
//alert(text.split(',')[2]);
//document.getElementById('deq_1234').textContent.style.display='none';
                // alert(deq_1234);
	       // MyApp.text=paper1;
